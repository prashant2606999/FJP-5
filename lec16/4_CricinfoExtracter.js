...
// npm install pdf-lib
// node 4_CricinfoExtracter.js --excel=Worldcup.csv --dataDir=worldcup --source=https://www.espncricinfo.com/series/icc-cricket-world-cup-2019-1144415/match-results
...
responseKaPromise.then(function(response){
    ...
    let matchScoreDivs = document.querySelectorAll("div.ds-p-4 div.ds-text-compact-xxs");
    let matches = [];
    ...
    for(let i = 0; i < matchScoreDivs.length; i++){
        ...
        let teamParas = matchScoreDivs[i].querySelectorAll(".ds-text-tight-m.ds-font-bold.ds-capitalize.ds-truncate");
        match.t1 = teamParas[0].textContent;
        match.t2 = teamParas[1].textContent;

        let scoreSpans = matchScoreDivs[i].querySelectorAll("div.ds-text-compact-s.ds-text-typo-title.ds-text-right > strong");
        ...
        let resultSpan = matchScoreDivs[i].querySelector(".ds-text-tight-s.ds-font-regular.ds-truncate.ds-text-typo-title");
